...
from src.ui.components.shared import render_security_alerts as _render_security_alerts
from src.ui.components.shared import render_export_buttons as _render_export_buttons
...
def render(client: APIClient) -> None:
    ...
    if submitted:
        ...
        import time
        _last_render = 0.0
        _RENDER_INTERVAL = 0.15  # throttle token rendering to ~7 fps
